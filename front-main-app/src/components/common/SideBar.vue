    ...
    <ul class="nav navbar-nav side-nav nicescroll-bar">
      ...
      <!-- <li>
        ...
        <ul id="dashboard_dr" class="collapse collapse-level-1">
          <li>
            <a class="active-page" href="javascript:;">Analytical</a>
          </li>
          <li>
      ...
      <li>
        <router-link to="/home">
          <div class="pull-left">
            ...
            ><span class="right-nav-text">首页</span>
          </div>
      ...
      <li>
        <router-link to="/search">
          <div class="pull-left">
            <i class="zmdi zmdi-flag mr-20"></i
            ><span class="right-nav-text">搜索指标</span>
          </div>
          <!-- <div class="pull-right">
            <span class="label label-warning">8</span>
          </div> -->
      ...
      <li>
        <router-link to="/detail">
          <div class="pull-left">
            <i class="zmdi zmdi-flag mr-20"></i
            ><span class="right-nav-text">指标详情</span>
          </div>
          <!-- <div class="pull-right">
            <span class="label label-warning">8</span>
          </div> -->
      ...
      <li>
        <router-link to="/chat">
          <div class="pull-left">
            <i class="zmdi zmdi-flag mr-20"></i
            ><span class="right-nav-text">金融问答</span>
          </div>
          <!-- <div class="pull-right">
            <span class="label label-warning">8</span>
          </div> -->
      ...
      <!-- <li>
        ...
        >
          <div class="pull-left">
            ...
            ><span class="right-nav-text">Apps </span>
          </div>
          <div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div>
          <div class="clearfix"></div>
        </a>
      ...
      <li>
        ...
        >
          <div class="pull-left">
            ...
            ><span class="right-nav-text">maps</span>
          </div>
          <div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div>
          <div class="clearfix"></div>
        </a>
      ...
      <li>
        ...
        >
          <div class="pull-left">
            <i class="zmdi zmdi-filter-list mr-20"></i
            ><span class="right-nav-text">multilevel</span>
          </div>
          <div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div>
          <div class="clearfix"></div>
        </a>
